...
- **按场景跳转**
- **设备 / UI 执行**：从 [快速开始](#quick-start)、[Top10 核心能力](#top10) 和 [设备域实战](device-playbook.md) 入手
...
## ⭐️ 性能实战教学
完整性能案例和星图样例已拆到独立文档：[docs/performance-playbook.md](performance-playbook.md)。
...
需要字段级骨架、`env / items / concurrency / fail_fast` 的真实写法时，直接看 [docs/cli-code.md](cli-code.md) 和 [docs/api-playbook.md](api-playbook.md)。
...
## ⭐️ 多媒体链路实战教学
完整媒体命令、组合链路和星图任务已拆到独立文档：[docs/media-playbook.md](media-playbook.md)。
