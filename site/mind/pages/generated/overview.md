...
- 开发或维护项目：看 [项目架构](#architecture) 和 [正文目录](docs-index.md)
...
依赖方向、状态所有权和生命周期以 [ARCHITECTURE.md](repository-architecture.md) 为准；产品背景与生态能力见[背景与架构](architecture.md)。
...
提交代码前请先阅读 [AGENTS.md](agents.md)、[ARCHITECTURE.md](repository-architecture.md) 和[维护者指南](maintainer-guide.md)，并根据影响范围运行定向测试和文档校验。
