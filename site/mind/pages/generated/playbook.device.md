...
- 启动时通过 `--helix` 接入 Helix
- 在已连接会话中用 `/helix-mode` 选择 `app`
- `app` 覆盖设备、媒体、应用性能和步骤规划能力
...
设备与 UI 执行负责真的操作设备；多媒体处理负责截图、录屏、音视频和证据加工；协议与校验、性能采样负责接口与报告链路。
