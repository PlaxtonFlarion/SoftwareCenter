...
### 分层与职责 (Layers and Responsibilities)
...
### 执行闭环与证据链 (Execution Loop and Evidence Chain)
执行闭环：
```text
模型生成意图
  ↓
...
### 统一推理流水线 (Unified Inference Flow)
1. BGE 语义召回
2. Cross Encoder 精排
3. 视觉模型做状态确认与目标定位
