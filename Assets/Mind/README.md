...
- 设备、多媒体和稳定性：看 [设备与 UI 实战](docs/playbook.device.md)、[Monkey 扰动](docs/playbook.monkey.md)、[多媒体链路](#playbook-media)、[性能实战](#playbook-performance)、[压测实战](#playbook-load)
...
## ⭐️ 压测实战
完整压测边界、典型跑法和结果收束说明已拆到独立正文：[压测实战](docs/playbook.load.md)。
