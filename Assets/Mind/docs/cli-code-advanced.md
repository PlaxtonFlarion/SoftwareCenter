...
- 你已经知道 `mind flow` 的基本格式，但不确定前后置到底谁包谁、谁覆盖谁：看这里
...
- `global_rule / rule` 属于 `mind flow` 的星图文本层
...
```text
mind flow --mode chat a.md b.md c.md
```
...
### 以为 `global_rule / rule` 会触发独立工具链路
⚠️ 不对。

它们只是任务正文的一部分，用来表达验收、约束或留证要求。
